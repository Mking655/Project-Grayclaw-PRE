...
public class AIController : MonoBehaviour
{
    ...
    public float edgeDistance = 0.5f;               //  Max distance to calculate the a minimum and a maximum raycast when hits something
    ...
    void EnviromentView()
    {
        ...
        for (int i = 0; i < playerInRange.Length; i++)
        {
            ...
            if (Vector3.Angle(transform.forward, dirToPlayer) < viewAngle / 2)
            {
                ...
                {
                    m_playerInRange = true;             //  The player has been seen by the enemy and then the enmy starts to chasing the player
